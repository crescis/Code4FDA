function[RMSP,RMSC,Y_full,Y_s2,real_func,alpha_s2,RMSP_series,RMSC_series] = s2cv(N,I,M_pc,I0,lambda_series,lambda1)
...
algpara.lambda2 = 0; %control sum-of-norms regularizer term
...
for i = (1:k)
algpara.lambda2 = lambda_series(i);
%ADLPMM
[x,y,z,record] = ADLPMM_2(x0,y0,z0,Q_new,A_final,b,T_inv,algpara);
%add test data to avoid overfitting
% rng(427)
% [A_origin,A,b,Y_full,real_func,Y_pca] = datagenerate_s2(N,I,M_pc,I0);
% [A_final,Q,Q_new,d,algpara,T_inv,x0,y0,z0] = datagenerate_2(A_origin,M_pc,I,N);
% A_final = blockdiag(A_origin,M_pc);
